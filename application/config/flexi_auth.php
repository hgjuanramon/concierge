...
$config['database']['user_acc']['custom_columns'] = array('uacc_first_name', 'uacc_last_name', 'uacc_phone', 'uacc_cel_phone', 'uacc_plaza_id', 'uacc_image');
...
$config['email']['reply_email'] = "hellohouse@hellohouse.com.mx";
