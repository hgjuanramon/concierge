    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart(backend_current_route(true) . $record->promotion_id, array('class' => 'form-horizontal')); ?>
                <?php
                ...
                <div class="form-actions text-center">
                    ...
                    <?php echo build_anchor(backend_current_route(), 'Cancelar', array('class' => 'btn btn-default')); ?>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
