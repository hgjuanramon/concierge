...
class Admin extends Back_Controller {
    ...
    public function __construct() {
        ...
        $this->_model = & $this->activity_model;
        $this->_init();
        $this->_set_active_nav('admin/' . $this->_module_name);
        $this->template->title('Lista actividades');
    }
    ...
    public function index() {
        ...
        $this->template->set('headline', 'Listado actividades');
    ...
    protected function _render_breadcrumb() {
        $this->_breadcrumb = array(
            array('label' => 'Actividades', 'location' => backend_current_route()),
